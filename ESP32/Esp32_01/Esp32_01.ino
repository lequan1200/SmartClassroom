...
// Relay - active LOW
#define RELAY_LIGHT1  25   // Den 1 (chinh)
#define RELAY_LIGHT2  33   // Den 2 (phu)
#define RELAY_FAN     21   // Quat
...
// Coi hu bao dong (Siren: duoc Pi 5 ra lenh tu xa)
...
void setup() {
  ...
  Serial.println("\n====================================");
  Serial.println(" ESP32 SMART CLASSROOM (THIN GATEWAY)");
  Serial.println("====================================");
