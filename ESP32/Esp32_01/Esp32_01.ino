...
#define RELAY_LIGHT2  33   // Đèn 2 (phụ)
...
// Để 0 để đọc trực tiếp giá trị ADC raw (400-1000 trong phòng thường)
const int AQ_CALIBRATION_OFFSET = 0;
...
void docCamBien() {
  ...
  // Log giám sát
  Serial.printf("[DATA Room01] T=%.1fC | H=%.1f%% | Lux=%.1f | AQ=%d (%s)\n",
